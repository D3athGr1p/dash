...
versions of Tor see [Section 4](#4-automatically-listen-on-tor)._
    ...
    HiddenServicePort 12972 127.0.0.1:9996
    HiddenServicePort 19999 127.0.0.1:19996

The directory can be different of course, but virtual port numbers should be equal to
your dashd's P2P listen port (12972 by default), and target addresses and ports
...
and open port 12972 on your firewall (or use port mapping, i.e., `-upnp` or `-natpmp`).
